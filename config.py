...
# Postgres (addon Railway) -- dipakai hem_db_service.py buat tabel
# data_semesta (fitur HEM / Input Data Semesta). Railway otomatis nyuntik
# env var ini begitu addon Postgres di-attach ke service, tidak perlu
# diisi manual.
